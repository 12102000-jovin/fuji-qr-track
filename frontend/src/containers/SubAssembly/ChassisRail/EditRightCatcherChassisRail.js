...
const EditRightCatcherChassisRail = ({ open, onClose, chassisId }) => {
  ...
  const editChassisRail_API = `http://localhost:3001/SubAssembly/RightCatcherChassisRail/editRightCatcherChassisRail/${pdcId}/${chassisId}`;
  const fetchDashboardChassisRailData_API = `http://localhost:3001/Dashboard/${chassisId}/showRightCatcherChassisRailDashboard`;
...
export default EditRightCatcherChassisRail;
