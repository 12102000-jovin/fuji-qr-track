...
const EditLeftCatcherChassisRail = ({ open, onClose, chassisId }) => {
  ...
  const editChassisRail_API = `http://localhost:3001/SubAssembly/LeftCatcherChassisRail/editLeftCatcherChassisRail/${pdcId}/${chassisId}`;
  const fetchDashboardChassisRailData_API = `http://localhost:3001/Dashboard/${chassisId}/showLeftCatcherChassisRailDashboard`;
...
export default EditLeftCatcherChassisRail;
