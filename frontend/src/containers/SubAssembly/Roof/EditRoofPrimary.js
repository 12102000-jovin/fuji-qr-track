...
const EditRoofPrimary = ({ open, onClose, roofId }) => {
  ...
  const editRoof_API = `http://localhost:3001/SubAssembly/RoofPrimary/editRoof/${pdcId}/${roofId}`;
...
export default EditRoofPrimary;
