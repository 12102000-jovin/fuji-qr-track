...
const EditMCCBCatcher = ({ open, onClose, MCCBId }) => {
  ...
  const fetchDashboardMCCBData_API = `http://localhost:3001/Dashboard/${MCCBId}/showMCCBCatcherDashboard`;
  const editMCCB_API = `http://localhost:3001/SubAssembly/MCCBCatcher/editMCCB/${pdcId}/${MCCBId}`;
...
export default EditMCCBCatcher;
