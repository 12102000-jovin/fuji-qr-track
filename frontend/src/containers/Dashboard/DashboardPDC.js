            ...
            <div className="flex justify-center flex-wrap">
              ...
              <div className="text-start mt-4 p-2 w-full md:w-1/2">
                <div className="w-full p-5 bg-white rounded-md min-h-40">
                  ...
                  {dashboardType === "PDC" ? (
                    dashboardData &&
                    dashboardData.leftCatcherChassisRails &&
                    dashboardData.leftCatcherChassisRails.length > 0 ? (
                      dashboardData.leftCatcherChassisRails.map(
                        (ChassisRail) => (
                          <div key={ChassisRail._id} className="flex flex-col">
                            <div className="font-normal">
                              <button
              ...
              <div className="text-start mt-4 p-2 w-full md:w-1/2">
                <div className="w-full p-5 bg-white rounded-md min-h-40">
                  ...
                  {dashboardType === "PDC" ? (
                    dashboardData &&
                    dashboardData.rightCatcherChassisRails &&
                    dashboardData.rightCatcherChassisRails.length > 0 ? (
                      dashboardData.rightCatcherChassisRails.map(
                        (ChassisRail) => (
                          <div key={ChassisRail._id} className="flex flex-col">
                            <div className="font-normal">
                              <button
              ...
              <div className="text-start mt-4 p-2 w-full md:w-1/2">
                <div className="w-full p-5 bg-white rounded-md min-h-40">
                  ...
                  {dashboardType === "PDC" ? (
                    dashboardData &&
                    dashboardData.catcherRoofs &&
                    dashboardData.catcherRoofs.length > 0 ? (
                      dashboardData.catcherRoofs.map((Roof) => (
                        <div key={Roof._id} className="flex flex-col">
                          <div className="font-normal">
                            <button
                              onClick={() => window.open(Roof.link, "_blank")}
