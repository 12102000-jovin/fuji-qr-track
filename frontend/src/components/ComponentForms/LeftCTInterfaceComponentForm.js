...
const LeftCTInterfaceComponentForm = (CTId) => {
  ...
  const AllocateLeftCTInterface_API =
    "http://localhost:3001/Allocate/AllocateLeftCTInterfaceComponent";
  ...
  const handleAllocate = async () => {
    ...
    try {
      ...
      const response = await axios.post(AllocateLeftCTInterface_API, {
        CTId: CTId.CTId,
        componentType: "Meter",
      ...
      if (response.status === 200) {
        ...
        setSuccessfulMessage(
          "Component Allocated to CT Interface (Left) successfully"
        );
...
export default LeftCTInterfaceComponentForm;
