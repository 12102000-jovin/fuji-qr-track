...
const ChassisRailRightPrimaryComponentForm = (chassisId) => {
  ...
  const AllocateRightPrimaryChassisRail_API =
    "http://localhost:3001/Allocate/AllocateRightPrimaryChassisRailComponent";
  ...
  const handleAllocate = async () => {
    try {
      ...
      const response = await axios.post(AllocateRightPrimaryChassisRail_API, {
      ...
      if (response.status === 200) {
        ...
        setSuccessfulMessage(
          "Component Allocated to Chassis Rail (Right) (Primary) successfully"
        );
...
export default ChassisRailRightPrimaryComponentForm;
