...
const ChassisRailLeftPrimaryComponentForm = (chassisId) => {
  ...
  const AllocateLeftPrimaryChassisRail_API =
    "http://localhost:3001/Allocate/AllocateLeftPrimaryChassisRailComponent";
  ...
  const handleAllocate = async () => {
    try {
      ...
      const response = await axios.post(AllocateLeftPrimaryChassisRail_API, {
      ...
      if (response.status === 200) {
        ...
        setSuccessfulMessage(
          "Component Allocated to Chassis Rail (Left) (Primary) successfully"
        );
...
export default ChassisRailLeftPrimaryComponentForm;
