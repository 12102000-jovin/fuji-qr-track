...
const ChassisRailLeftCatcherComponentForm = (chassisId) => {
  ...
  const AllocateLeftCatcherChassisRail_API =
    "http://localhost:3001/Allocate/AllocateLeftCatcherChassisRailComponent";
  ...
  const handleAllocate = async () => {
    try {
      ...
      const response = await axios.post(AllocateLeftCatcherChassisRail_API, {
      ...
      if (response.status === 200) {
        ...
        setSuccessfulMessage(
          "Component Allocated to Chassis Rail (Left) (Catcher) successfully"
        );
...
export default ChassisRailLeftCatcherComponentForm;
